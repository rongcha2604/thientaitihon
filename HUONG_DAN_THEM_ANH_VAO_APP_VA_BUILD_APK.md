...
1. ✅ Thêm 10 ảnh đã tạo vào app
2. ✅ Update imageUrl trong JSON files
...
### 1.1. Kiểm Tra Thư Mục

Thư mục đã có sẵn: `public/data/questions/images/math/`

### 1.2. Copy 10 Ảnh Đã Tạo
...
├── math-question-ket-noi-tri-thuc-grade1-week13-q4.png
├── math-question-ket-noi-tri-thuc-grade1-week13-q5.png
├── math-question-ket-noi-tri-thuc-grade1-week13-q6.png
├── math-question-ket-noi-tri-thuc-grade1-week14-q5.png
└── ... (10 ảnh đầu tiên)
```

**Lưu ý:** 
- ✅ Đảm bảo tên file đúng với tên trong `math-question-image-prompts.md`
- ✅ File phải là `.png` format
- ✅ Không có khoảng trắng, ký tự đặc biệt trong tên file

### 1.3. Kiểm Tra Ảnh Đã Copy

```powershell
# Kiểm tra số lượng ảnh
Get-ChildItem -Path "public/data/questions/images/math" -Filter "*.png" | Measure-Object | Select-Object -ExpandProperty Count

# Liệt kê tất cả ảnh
Get-ChildItem -Path "public/data/questions/images/math" -Filter "*.png" | Select-Object Name
```
...
- ✅ Tự động update `imageUrl` trong JSON files (trong `src/data/questions/`)
...
Script sẽ hiển thị:
```
📖 Đang đọc prompts file: math-question-image-prompts.md
🔍 Tìm thấy 72 filenames trong prompts file
📸 Tìm thấy 10 ảnh trong public/data/questions/images/math
📂 Tìm thấy 18 file JSON math
============================================================
✅ Updated: ket-noi-tri-thuc/grade-1/math/week-1.json - q1
✅ Updated: ket-noi-tri-thuc/grade-1/math/week-1.json - q2
✅ Updated: ket-noi-tri-thuc/grade-1/math/week-13.json - q1
...
💾 Đã lưu: week-1.json
💾 Đã lưu: week-13.json
============================================================
...
```powershell
# Kiểm tra JSON files
Get-ChildItem -Path "public/data/questions/ket-noi-tri-thuc/grade-1/math" -Filter "*.json" | Select-Object -First 5
...
## 📋 BƯỚC 4: Test Trong Browser (Optional - Khuyến Nghị)
...
### 5.2. Build APK Thủ Công (Nếu Cần)
...
- **Chức năng thưởng items:** Đã có sẵn, không cần làm gì thêm
  - ✅ Album items (characters, accessories, frames, stickers)
  - ✅ Coins system (thưởng khi hoàn thành bài tập)
  - ✅ Purchase items (đổi coins lấy items)
  - ✅ User collection (lưu items đã mua)
...
- `HUONG_DAN_THEM_ANH_VAO_APP.md` - Hướng dẫn chi tiết hơn
- `BUILD_APK.md` - Hướng dẫn build APK
- `math-question-image-prompts.md` - Danh sách prompts và filenames
